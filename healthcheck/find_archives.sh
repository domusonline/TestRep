...
# Only works for simple ontape(?) backups with all dbspaces

ONLINELOG=$1

egrep -e "^(Mon|Tue|Wed|Thu|Fri|Sat|Sun) (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) *[0-9][0-9]* [0-9]*:[0-9]*:[0-9]* [0-9][0-9][0-9][0-9] *$" -e "Archive" $ONLINELOG  | awk ' BEGIN {
		MONTH_ARRAY["Jan"] = "01";
		MONTH_ARRAY["Feb"] = "02";
		MONTH_ARRAY["Mar"] = "03";
		MONTH_ARRAY["Apr"] = "04";
